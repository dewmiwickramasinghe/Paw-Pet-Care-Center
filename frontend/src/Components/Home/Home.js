      ...
      <section className="about">
        <div className="container about-grid">
          <div className="about-image">
            <img src="" alt="Our veterinary team" />
          </div>
          <div className="about-content">
            ...
            <button className="cta-button outline">Meet Our Team</button>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="testimonial-grid">
            <div className="testimonial-card">
              ...
              <p>"The most caring and professional staff we've ever encountered. They saved our golden retriever's life!"</p>
